...
function applyCanonInformation() {
  ...
  if (canonEnding) {
    ...
    canonEnding.requirements = [
      "Amikor a szem hosszabb emléksort mutat, maradj 7 percig ugyanazon a jeleneten. Ezután megjelenik egy titkos opció, amely A Tanú befejezést adja."
    ];
  ...
  if (canonSecret) {
    canonSecret.condition =
      "Amikor a szem hosszabb emléksort mutat, maradj 7 percig ugyanazon a jeleneten.";
    canonSecret.note =
