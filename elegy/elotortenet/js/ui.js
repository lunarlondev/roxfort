...
export class StoryUI {
  ...
  renderEnding(node) {
    ...
    /*
     * Minden elért befejezésnél elindítja a fejezetváltóhoz hasonló
     * lezáró overlayt. Az isNew alapján külön jelezhető, ha most
     * fedezte fel először az olvasó az adott endinget.
     */
    dispatchStoryEvent("story:endingReached", {
      id: node.endingId,
      title: node.title || "Az út vége",
